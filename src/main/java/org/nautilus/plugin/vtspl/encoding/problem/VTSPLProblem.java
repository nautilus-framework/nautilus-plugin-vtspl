package org.nautilus.plugin.vtspl.encoding.problem;
...
public class VTSPLProblem extends NBinaryProblem {

	private static final long serialVersionUID = 1233594822176588853L;

	public VTSPLProblem(Instance instance, List<AbstractObjective> objectives) {
